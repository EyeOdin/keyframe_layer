...
DOCKER_ID = "pykrita_keyframe_layer"

# Register the docker so Krita can use it!
Application.addDockWidgetFactory( DockWidgetFactory(DOCKER_ID, DockWidgetFactoryBase.DockRight, KeyFrame_Layer_Docker) )
